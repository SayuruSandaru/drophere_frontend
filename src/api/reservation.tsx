...
export const createReservation = async (reservation: {
    ...
    try {
        ...
        const errorMessage = error.message || 'An error occurred during reservation creation';
...
export const createDeliveryOrder = async (order: {
    ...
    try {
        ...
        const errorMessage = error.message || 'An error occurred during delivery order creation';
